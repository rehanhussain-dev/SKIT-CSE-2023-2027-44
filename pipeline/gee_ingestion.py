...
def export_weekly_composites(roi_coords, start_date, end_date, drive_folder='vhr_yieldnet_weekly'):
    ...
    print(f"Processing {len(intervals)} weekly windows into Drive folder '{drive_folder}'...")
    ...
    for w_start, w_end, file_tag in intervals:
        s2_collection = (
            ...
            .linkCollection(csPlus.filterBounds(buffered_roi).filterDate(w_start, w_end), ['cs_cdf'])
